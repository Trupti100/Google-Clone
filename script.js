  ...
  leftMenu.innerHTML = `
    <div class="left-menu__content">
        <a href="index.html" class="left-menu__img">
            <img src="assets/google photo.png" alt="Google Clone">
        </a>
